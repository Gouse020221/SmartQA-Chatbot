...
//	}
	 ...
	 @AfterAll
	    public static void generateAIReport() {
	        logger.info("All scenarios completed. Reports will be generated by ReportGeneratorPlugin...");
	        // Note: Professional report and email report generation is now handled by ReportGeneratorPlugin
	        // which runs after TestRunFinished event, ensuring JSON file is available
	    }
