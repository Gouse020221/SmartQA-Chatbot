...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "pretty, html:target/cucumber-reports/cucumber.html, json:target/cucumber-reports/Cucumber.json, com.driverUtility.ReportGeneratorPlugin")
